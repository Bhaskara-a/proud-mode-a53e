...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/proud-mode-a53e
```

A live public deployment of this template is available at [https://proud-mode-a53e.templates.workers.dev](https://proud-mode-a53e.templates.workers.dev)
